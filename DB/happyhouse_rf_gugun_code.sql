...
CREATE TABLE `gugun_code` (
  ...
  `sido_code` char(2) DEFAULT NULL,
  PRIMARY KEY (`code`),
  KEY `FK_SIDO_GUGUN_idx` (`sido_code`),
  CONSTRAINT `FK_SIDO_GUGUN` FOREIGN KEY (`sido_code`) REFERENCES `sido_code` (`code`)
